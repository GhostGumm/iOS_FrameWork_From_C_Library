...
//  MosquittoIOs
//
//  Created by Hakim on 27/07/15.
//  Copyright (c) 2015 Hakim. All rights reserved.
//

#import "ZetaInit+ZetaWrap.h"

@implementation ZetaIOs
...
{
    return cometd_group_create_request(self->client->cometClient, self->hm, SDepId, Group, GroupName);
}
